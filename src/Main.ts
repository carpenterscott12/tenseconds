export function Main() {
    ...
    class Job {
        ...
        finishTask(taskID: number) {
            ...
            if (taskToFinish === undefined) {
                throw "taskToFinish was undefined";
            }
            taskToFinish.finish();
            this.totalTasksCompleted++;
            if (taskToFinish.taskID + 1 > maxTaskID) {
    ...
    class JobTask {
        ...
        public requiredKeysIndex: number;
        public taskComplete: boolean;
        public isActiveTask: boolean;
        constructor(taskID: number, taskName: string, taskDescription: string, requiredKeys: Array<string>) {
            this.taskID = taskID;
